    ...
    switch (dim)
    {
        ...
        case 1:
            switch (data_type)
            {
                ...
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<float, 1> decompression_variable(file_name);
                ...
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<double, 1> decompression_variable(file_name);
                    decompression_variable.Decompress();
        ...
        case 2:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<float, 2> decompression_variable(file_name);
                    decompression_variable.Decompress();
                    const std::vector<float> decompressed_data = decompression_variable.GetDecompressedData();
                    WriteOutDecompressedData<float>(output_file, decompressed_data);
                }
                ...
                case cmc::CmcType::Double:
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<double, 2> decompression_variable(file_name);
                    decompression_variable.Decompress();
                    const std::vector<double> decompressed_data = decompression_variable.GetDecompressedData();
                    WriteOutDecompressedData<double>(output_file, decompressed_data);
                }
        ...
        case 3:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<float, 3> decompression_variable(file_name);
                    decompression_variable.Decompress();
                    const std::vector<float> decompressed_data = decompression_variable.GetDecompressedData();
                    WriteOutDecompressedData<float>(output_file, decompressed_data);
                }
                ...
                case cmc::CmcType::Double:
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<double, 3> decompression_variable(file_name);
                    decompression_variable.Decompress();
                    const std::vector<double> decompressed_data = decompression_variable.GetDecompressedData();
                    WriteOutDecompressedData<double>(output_file, decompressed_data);
                }
        ...
        case 4:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<float, 4> decompression_variable(file_name);
                    decompression_variable.Decompress();
                    const std::vector<float> decompressed_data = decompression_variable.GetDecompressedData();
                    WriteOutDecompressedData<float>(output_file, decompressed_data);
                }
                ...
                case cmc::CmcType::Double:
                {
                    cmc::patch::lossless::multi_res::fast::DecompressionVariable<double, 4> decompression_variable(file_name);
                    decompression_variable.Decompress();
                    const std::vector<double> decompressed_data = decompression_variable.GetDecompressedData();
                    WriteOutDecompressedData<double>(output_file, decompressed_data);
                }
