...
#include "patch/lossy/cmc_multi_res_extraction_idw.hxx"
        ...
        case 2:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    ...
                    cmc::patch::lossy::multi_res::idw::CompressionVariable<float, 2> compression_variable(std::span<const float>(data), dims, abs_error);
                ...
                case cmc::CmcType::Double:
                {
                    ...
                    cmc::patch::lossy::multi_res::idw::CompressionVariable<double, 2> compression_variable(std::span<const double>(data), dims, abs_error);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
        ...
        case 3:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    ...
                    const std::vector<float> data = binary_reader.ReadData();
                    cmc::patch::lossy::multi_res::idw::CompressionVariable<float, 3> compression_variable(std::span<const float>(data), dims, abs_error);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
                case cmc::CmcType::Double:
                {
                    ...
                    const std::vector<double> data = binary_reader.ReadData();
                    cmc::patch::lossy::multi_res::idw::CompressionVariable<double, 3> compression_variable(std::span<const double>(data), dims, abs_error);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
