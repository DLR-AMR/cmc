    ...
    switch (dim)
    {
        ...
        case 1:
            switch (data_type)
            {
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<float, 1> var(input_variables.front());
                    var.Compress();
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<double, 1> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int16_t, 1> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint16_t, 1> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int32_t, 1> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint32_t, 1> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int64_t, 1> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint64_t, 1> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
        ...
        case 2:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<float, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Double:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<double, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Int16_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int16_t, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Uint16_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint16_t, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Int32_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int32_t, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Uint32_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint32_t, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Int64_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int64_t, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Uint64_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint64_t, 2> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
        ...
        case 4:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<float, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Double:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<double, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Int16_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int16_t, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Uint16_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint16_t, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Int32_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int32_t, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Uint32_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint32_t, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Int64_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<int64_t, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
                ...
                case cmc::CmcType::Uint64_t:
                {
                    cmc::patch::lossless::prefix::plain_suffix::PatchCompressionVariable<uint64_t, 4> var(input_variables.front());
                    var.Compress();
                    cmc::compression_io::serial::Writer writer(output_file);
                    writer.SetVariable(&var);
                    writer.Write();
...
main(int argc, char *argv[])
{
    ...
    {
        DisplayHelpMessage();
        cmc::cmc_err_msg("The specified dimensionality (", dim, ") is not supported. Currently, only 1D, 2D, 3D and 4D compression is supported.");
    }
