        ...
        case 1:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    ...
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<float, 1> compression_variable(std::span<const float>(data), dims);
                ...
                case cmc::CmcType::Double:
                {
                    ...
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<double, 1> compression_variable(std::span<const double>(data), dims);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
        ...
        case 2:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    ...
                    const std::vector<float> data = binary_reader.ReadData();
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<float, 2> compression_variable(std::span<const float>(data), dims);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
                case cmc::CmcType::Double:
                {
                    ...
                    const std::vector<double> data = binary_reader.ReadData();
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<double, 2> compression_variable(std::span<const double>(data), dims);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
        ...
        case 3:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    ...
                    const std::vector<float> data = binary_reader.ReadData();
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<float, 3> compression_variable(std::span<const float>(data), dims);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
                case cmc::CmcType::Double:
                {
                    ...
                    const std::vector<double> data = binary_reader.ReadData();
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<double, 3> compression_variable(std::span<const double>(data), dims);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
        ...
        case 4:
            switch (data_type)
            {
                case cmc::CmcType::Float:
                {
                    ...
                    const std::vector<float> data = binary_reader.ReadData();
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<float, 4> compression_variable(std::span<const float>(data), dims);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
                case cmc::CmcType::Double:
                {
                    ...
                    const std::vector<double> data = binary_reader.ReadData();
                    cmc::patch::lossless::multi_res::fast::CompressionVariable<double, 4> compression_variable(std::span<const double>(data), dims);
                    compression_variable.Compress();
                    compression_variable.WriteCompressedData(output_file);
                }
                break;
