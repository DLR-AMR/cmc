#ifndef LOSSLESS_CMC_EMBEDDED_BYTE_COMPRESSION_EXTENDED_VARIABLE_HXX
#define LOSSLESS_CMC_EMBEDDED_BYTE_COMPRESSION_EXTENDED_VARIABLE_HXX
...
namespace cmc::lossless::embedded::extended
{
...
public:
    ...
    virtual ResidualData<T> ComputeResiduals(t8_forest_t forest_old, t8_forest_t forest_new, t8_locidx_t which_tree,
...
private:
    ...
    //void ResidualComputation(t8_forest_t previous_forest, t8_forest_t coarsened_forest, t8_locidx_t tree_id,
    //                            const t8_eclass_t tree_class, const t8_scheme_c *scheme, const int refine,
    //                            const int num_outgoing, const t8_locidx_t first_outgoing, const int num_incoming,
                    ...
                    const t8_locidx_t first_incoming)
{
    ...
    const ResidualData<T> residuals = adapt_data->ComputeResiduals(previous_forest, coarsened_forest, tree_id, tree_class, scheme, refine, num_outgoing,
...
IEmbeddedCompressionAdaptData<T>::CompleteExtractionIteration(const t8_forest_t previous_forest, const t8_forest_t adapted_forest)
{
    ...
    cmc_debug_msg("The residual computation has been finished.");
}
...
#endif /* !LOSSLESS_CMC_EMBEDDED_BYTE_COMPRESSION_EXTENDED_VARIABLE_HXX */
