#ifndef CMC_IFACE_ABSTRACT_BYTE_DECOMPRESSION_VARIABLE_HXX
#define CMC_IFACE_ABSTRACT_BYTE_DECOMPRESSION_VARIABLE_HXX
...
template <typename T>
class IByteDecompressionVariable
{
public:
...
#endif /* !CMC_IFACE_ABSTRACT_BYTE_DECOMPRESSION_VARIABLE_HXX */
