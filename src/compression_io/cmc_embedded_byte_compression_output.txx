...
CommunicateOffsets(cmc::IEmbeddedAMRCompressionVariable<T>* variable, const MPI_Comm comm)
{
...
template<typename T>
void
Writer::SetDataVariable(cmc::IEmbeddedAMRCompressionVariable<T>* variable, const std::vector<VariableLevelOffset>& level_byte_counts, const std::vector<IntraLevelStreamOffset>& intra_level_offsets, const int var_id, const int corresponding_mesh_id)
{
...
template<typename T>
void
Writer::SetMeshVariable(cmc::IEmbeddedAMRCompressionVariable<T>* variable, const std::vector<VariableLevelOffset>& level_byte_counts, const std::vector<IntraLevelStreamOffset>& intra_level_offsets, const int mesh_id)
{
...
template<typename T>
void
Writer::SetVariable(cmc::IEmbeddedAMRCompressionVariable<T>* variable)
{
