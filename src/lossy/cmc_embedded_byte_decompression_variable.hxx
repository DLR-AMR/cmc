#ifndef LOSSY_CMC_EMBEDDED_BYTE_DECOMPRESSION_VARIABLE_HXX
#define LOSSY_CMC_EMBEDDED_BYTE_DECOMPRESSION_VARIABLE_HXX
...
protected:
    ...
    virtual void PostDecompressionProcessing([[maybe_unused]] std::vector<CompressionValue<T>>& decompressed_data){}
...
#endif /* !LOSSY_CMC_EMBEDDED_BYTE_DECOMPRESSION_VARIABLE_HXX */
