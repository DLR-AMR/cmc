...
IMeshEncoder::DetermineSendingRange(const uint64_t current_local_bit_idx, const uint64_t current_global_bit_idx, const uint64_t num_global_byte_packages, const int comm_size)
{
...
IMeshEncoder::DetermineSendMessages(const uint64_t num_global_bits, const uint64_t global_bit_offset, const int comm_size)
{
...
IMeshEncoder::GetPartitionedEncodedLevelData(t8_forest_t adapted_mesh, t8_forest_t partitioned_mesh, MPI_Comm comm)
{
