...
main(void)
{
    ...
    std::vector<cmc::nc::Variable> variables;

    /* Define a variable of a specified data type */
    const int testid = 1;
    cmc::nc::SpecificVariable<double> dvar{"test_var", testid};
    ...
    cmc::nc::Attribute fattr{"attr", static_cast<float>(1.5)};

    std::vector<cmc::nc::Attribute> dvar_attributes;
    dvar_attributes.push_back(fattr);

    /* Create a global attribute */
    cmc::nc::Attribute global_attr{"global_attr", static_cast<int16_t>(255)};

    const std::string file_name = "test_nc_output_file.nc";
    const int netcdf_format = NC_64BIT_OFFSET;

    /* Create an output writer */
    cmc::nc::Writer writer{file_name, netcdf_format};
    ...
    cmc::nc::Reader reader{file_name};
    ...
    const std::vector<cmc::nc::Dimension> test_var_dims = read_variables.front().GetDimensions();
    ...
    const std::vector<cmc::nc::Attribute> test_var_atts = read_variables.front().GetAttributes();
    ...
    cmc::nc::SpecificVariable<double> spec_var = read_variables.front().DetachVariable<double>();
