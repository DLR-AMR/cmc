...
main(void)
{
    ...
    /* Setup an embedded MultiResAMR compression variable (utilizing the pcp4 residual computation and encoding )from the input variables */
    cmc::lossless::embedded::test_pcp4::EmbeddedCompressionVariable<float> var(input_variables.front());
...

    {
        ...
        cmc::compression_io::nc::Writer writer("multi_res_pcp4_example_lossless_compression_output.cmc", MPI_COMM_SELF);
    ...
    cmc::compression_io::nc::Reader reader("multi_res_pcp4_example_lossless_compression_output.cmc", MPI_COMM_SELF);
