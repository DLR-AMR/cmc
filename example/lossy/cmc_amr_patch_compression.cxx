...
main(void)
{
    ...
    //                         cmc::DimensionInterval(cmc::Dimension::Lat, 360, 376),
    ...
    //cmc::CmcUniversalType missing_value(static_cast<float>(2048.000000));//temp
    //cmc::CmcUniversalType missing_value(static_cast<float>(31866786.000000));//Velocity x
    cmc::CmcUniversalType missing_value(static_cast<float>(3224.5));//Temp hurricane
    ...
    //cmc::patch_amr::Compressor compression_data(nc_data.TransferData(), std::move(settings));
    cmc::patch_amr::Compressor compression_data(std::move(vars), std::move(settings));
    
    cmc::cmc_debug_msg("\n\nCompressor has been instantiated\n\n");
