...
//#include "lossy/cmc_multi_res_scanline_compression.hxx"
#include "lossy/cmc_embedded_idw_extraction_compression.hxx"
...
//const double kRelMaxError = 0.0001;
const double kRelMaxError = cmc::lossy::embedded::idw::test_rel_err;
const double kAbsMaxError = cmc::lossy::embedded::idw::test_abs_err;;
...
main(void)
{
    ...
    //cmc::lossy::embedded::multi_res::scanline::EmbeddedCompressionVariable<float> var(settings, input_variables.front());
    cmc::lossy::embedded::idw::EmbeddedCompressionVariable<float> var(settings, input_variables.front());
    ...
    #if 0
    {
        ...
        cmc::compression_io::nc::Writer writer("trimmed_multi_res_example_lossy_compression_output.cmc", MPI_COMM_SELF);
...
main(void)
{
    ...
    //cmc::compression_io::nc::Reader reader("example_lossless_compression_output.cmc", MPI_COMM_WORLD);
    //
