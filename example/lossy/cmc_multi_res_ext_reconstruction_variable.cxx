...
//#include "lossy/cmc_embedded_multi_res_extraction_nearest_neighbor_reconstruction_trimmed_residuals.hxx"
#include "lossy/cmc_embedded_multi_res_extraction_nearest_neighbor_reconstruction.hxx"
...
main(void)
{
    ...
    cmc::lossy::embedded::multi_res::nearest_neighbor_reconstruction::EmbeddedCompressionVariable<float> var(settings, input_variables.front());
...

    {
        ...
        cmc::compression_io::nc::Writer writer("multi_res_ext_recon_example_lossy_compression_output.cmc", MPI_COMM_SELF);
