...
#include "embedded/lossy/cmc_embedded_prefix_quantization_compression.hxx"
...
const double kAbsMaxError = 0.00;
...
main(void)
{
    ...
    cmc::lossy::embedded::prefix::EmbeddedCompressionVariable<float> var(settings, input_variables.front());
    ...
    cmc::compression_io::nc::Reader reader("trimmed_multi_res_example_lossy_compression_output.cmc", MPI_COMM_SELF);
